...
class FarthestSystemSol extends Process
{
    static private $cacheKey = 'Statistics_SystemsController_FarthestSystemSol';
    ...
    static public function run()
    {
            ...
            foreach($result AS $record)
            {
                ...
                if(!is_null($firstDiscoveredBy))
                {
                    ...
                    $firstDiscoveredBy->giveBadge(
                        7800,
                        array('type' => 'farthestSystemSol', 'systemId' => $system->getId())
                    );
                }
        ...
        static::log('<span class="text-info">Record\FarthestSystemSol</span>');
